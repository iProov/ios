/*
 ...
 IPTSKPinningValidatorCallback.h
 TrustKit
...
#ifndef IPTSKPinningValidatorCallback_h
#define IPTSKPinningValidatorCallback_h
 ...
 */
typedef NSDictionary<IPTSKDomainConfigurationKey, id> TKSDomainPinningPolicy;
 ...
 * The `IPTSKPinningValidatorResult` resulting from the validation of the server's identity.
 ...
 */
typedef void (^IPTSKPinningValidatorCallback)(IPTSKPinningValidatorResult * _Nonnull result, NSString * _Nonnull notedHostname, TKSDomainPinningPolicy * _Nonnull policy);



#endif /* IPTSKPinningValidatorCallback_h */
