...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "iProov",
            url: "https://github.com/iProov/ios/raw/master/spm/iProov.xcframework.zip",
            checksum: "3389e7a103c1c782a37637dae7c317718c1b4ef8261a1bb9be4e09239de760b9"
        ),
        .binaryTarget(
            name: "SocketIO",
            url: "https://github.com/iProov/ios/raw/master/spm/SocketIO.xcframework.zip",
            checksum: "2950e7c585316a750feb2dbeeb911244fce860a79b693c7832d7d049936dd502"
        ),
        .binaryTarget(
            name: "Starscream",
            url: "https://github.com/iProov/ios/raw/master/spm/Starscream.xcframework.zip",
