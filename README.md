...
# iProov Biometrics iOS SDK v11.0.0-beta
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 11.0.0-beta as the lower bound.
...
.package(
	...
	.upToNextMajor(from: "11.0.0-beta")
),
```
...
4. Add the following files from the [release assets](https://github.com/iProov/ios/releases/tag/11.0.0-beta):
