...
# iProov Biometrics iOS SDK v10.1.0
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 10.1.0 as the lower bound.
...
4. Add the following 3 files from the [release assets](https://github.com/iProov/ios/releases/tag/10.1.0):
