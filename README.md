...
# iProov Biometrics iOS SDK v12.1.0-rc
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 12.1.0-rc as the lower bound.
...
4. Add `iProov.xcframework` from the [release assets](https://github.com/iProov/ios/releases/tag/12.1.0-rc).
