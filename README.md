...
# iProov Biometrics iOS SDK v11.1.1-rc
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 11.1.1-rc as the lower bound.
...
4. Add `iProov.xcframework` from the [release assets](https://github.com/iProov/ios/releases/tag/11.1.1-rc).
