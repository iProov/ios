...
# iProov Biometrics iOS SDK v11.0.2-binancetest
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 11.0.2-binancetest as the lower bound.
...
.package(
	...
	.upToNextMajor(from: "11.0.2-binancetest")
),
```
...
4. Add `iProov.xcframework` from the [release assets](https://github.com/iProov/ios/releases/tag/11.0.2-binancetest).
