...
# iProov Biometrics iOS SDK v10.0.1
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 10.0.1 as the lower bound.
...
4. Add the following 3 files from the [release assets](https://github.com/iProov/ios/releases/tag/10.0.1):
...
| `certificates` | Certificates to be used for SSL pinning. [See below for further details](#certificates). | AlphaSSL intermediate certificate |
