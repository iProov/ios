...
# iProov Biometrics iOS SDK v10.3.3
...
3. Set the _Dependency Rule_ to be _Up to Next Major Version_ and input 10.3.3 as the lower bound.
...
4. Add `iProov.xcframework` from the [release assets](https://github.com/iProov/ios/releases/tag/10.3.3).
